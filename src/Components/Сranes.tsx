...
<div className={[s.div8,s.t].join(' ')}> Електрики</div>
{/* <div className={[s.div9].join(' ')}> </div> */}
<div className={[s.div10,s.t].join(' ')}> ммммм</div>
<div className={[s.div11,s.t].join(' ')}> №51906	</div>
...
<div className={[s.div27,s.t].join(' ')}> телега№ 051973</div>
